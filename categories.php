...
<head>
    ...
    <title><?php $category= $_GET['p_category'];
            echo $category;?></title>
...
<br> 
  ...
  box-sizing:border-box;
     ...
     .h1-1{
        ...
        color:white;
        padding-left:30px;
        background:linear-gradient(90deg,black,rgb(0,0,0,0));
...
<h1 class="h1-1"> <?php echo $category;?> </h1><br>
...
<div class="container">
    ...
    $page2=10;
      ...
      $sql="SELECT * from categories where p_category='$category' order by p_id desc LIMIT $page2  ";
...
while($show=mysqli_fetch_array($run)){
  ...
  ?>
      ...
      <?php
      if($status1=='sold'){?>
      <span style="transform:translate(20%,40%); position:absolute;" ><img src="./pictures/sold.png" alt="" style="width: auto; height:30px; opacity:0.8;"></span>
       <?php
      }?><?php
